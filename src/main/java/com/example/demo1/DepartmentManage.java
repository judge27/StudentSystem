...
public  class DepartmentManage extends Application {
    ...
    private void insertData() {
        ...
        try (Connection conn = DriverManager.getConnection(url, user, password);
            ...
            String insertQuery = "INSERT INTO departments (name, code) " +
                    "VALUES ('" + Name + "', '" + Code + "')"; // Add a closing single quote for Code
    ...
    private void updateData() {
        ...
        try (Connection conn = DriverManager.getConnection(url, user, password);
            ...
            String updateQuery = "UPDATE departments SET " +
                    "name = '" + updatedName + "' " + // Remove the comma here
    ...
    private void deleteData() {
        ...
        try (Connection conn = DriverManager.getConnection(url, user, password);
            ...
            String deleteQuery = "DELETE FROM departments WHERE code = '" + Code + "'";
