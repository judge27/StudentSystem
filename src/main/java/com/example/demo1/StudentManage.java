...
public  class StudentManage extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        grade.setStyle("-fx-font-size: 20;-fx-font-weight: bold; -fx-text-fill: black");
         tgrade = new TextField();
        HBox hBox4 = new HBox(10,grade,tgrade);
    ...
    private void insertData() {
        ...
        int newCode = Integer.parseInt(tcode.getText()); // Parse string code to an integer
        String newDept = tdept.getText();
        String newGrade = tgrade.getText();

        try (Connection conn = DriverManager.getConnection(url, user, password);
             Statement statement = conn.createStatement()) {

            String insertQuery = "INSERT INTO students (name, code, department, grade) " +
                    "VALUES ('" + newName + "', " + newCode + ", '" + newDept + "', '" + newGrade + "')";
    ...
    private void fetchStudentData() {
        ...
        try (Connection conn = DriverManager.getConnection(url, user, password);
            ...
            while (resultSet.next()) {
                ...
                StudentTable.studentTableView.getItems().add(student);
            }
    ...
    private void updateData() {
        ...
        String updatedGrade = tgrade.getText();
        ...
        try (Connection conn = DriverManager.getConnection(url, user, password);
            ...
            String updateQuery = "UPDATE students SET " +
                    "name = '" + updatedName + "', " +
                    "code = " + updatedCode + ", " + // Include code in the update query
                    "department = '" + updatedDept + "', " +
                    "grade = '" + updatedGrade + "' " +
                    "WHERE code = " + updatedCode; // Use the code to identify the row
    ...
    private void refreshTable() {
        StudentTable.studentTableView.getItems().clear(); // Clear the existing items in the TableView
